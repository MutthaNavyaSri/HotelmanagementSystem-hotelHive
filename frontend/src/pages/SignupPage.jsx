  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-emerald-900 to-slate-900 flex items-center justify-center p-4">
      <div className="bg-white rounded-xl shadow-2xl p-8 w-full max-w-md border-t-4 border-emerald-700">
        ...
        <p className="text-center text-slate-600 mb-8">Join us for amazing hotel experiences</p>
        ...
        <button
          ...
          disabled={isLoading || !!successMessage}
          className="w-full border border-slate-300 text-slate-700 py-2 rounded-lg font-semibold hover:bg-slate-50 active:bg-slate-100 transition flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
        >
